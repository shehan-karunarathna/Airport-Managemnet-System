...
const AirplaneReg = React.lazy(() => import('./views/AirPlane/AirplaneReg'))
const Airplanelist = React.lazy(() => import('./views/AirPlane/Airplanelist'))
const Airplaneedit = React.lazy(() => import('./views/AirPlane/Airplaneedit'))
const Airplanedelete = React.lazy(() => import('./views/AirPlane/Airplanedelete'))
const Createadmin = React.lazy(() => import('./views/Admindetails/Createadmin'))
...
const routes = [
  ...
  { path: '/AirPlane/AirplaneReg', name: 'AirplaneReg', element: AirplaneReg },
  { path: '/AirPlane/Airplanelist', name: 'Airplanelist', element: Airplanelist },
  {
    path: '/AirPlane/Airplaneedit/:registrationNumber',
    name: 'Airplaneedit',
